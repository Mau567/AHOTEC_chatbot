...
export default function Home() {
  ...
  const t = {
    // Header
    title: language === 'es' ? 'AHOTEC - Federación Hotelera del Ecuador' : 'AHOTEC - Ecuador Hotels Association',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                      {hotelResults.map((hotel, idx) => (
                        ...
                        >
                          ...
                          {hotel.recreationAreas && <div className="text-gray-500 text-sm mb-1"><b>Servicios / áreas recreativas:</b> {hotel.recreationAreas}</div>}
