...
export default function ChatWidget({ 
  ...
  const t = {
    ...
    bookingLinkLabel: language === 'es' ? 'Reservar' : 'Book',
                  ...
                  <div className="space-y-3 flex-1 overflow-y-auto">
                    {hotelResults.map((hotel, idx) => (
                      ...
                      >
                        ...
                        {hotel.websiteLink && (
                          <a href={hotel.websiteLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline mt-1 text-xs block">{t.websiteLinkLabel}</a>
                        )}
                        {hotel.bookingLink && (
